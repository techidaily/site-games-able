---
title: 20 Ways to Improve Gaming Performance on Your Laptop
date: 2024-07-03T12:00:18.905Z
updated: 2024-07-04T12:00:18.905Z
tags:
  - games
categories:
  - games
description: This Article Describes 20 Ways to Improve Gaming Performance on Your Laptop
excerpt: This Article Describes 20 Ways to Improve Gaming Performance on Your Laptop
keywords: Enhancing Laptop Gaming Experience,Gaming Performance Tips,Laptop Gaming Optimization Techniques,Maximize Laptop Gaming Performance,Improving Graphics Settings for Laptops,Boosting Laptop Processor Speed for Gaming,Laptop Overclocking for Better Gaming
...
![ferrite bead on a laptop charging cable](https://static1.makeuseofimages.com/wordpress/wp-content/uploads/2021/09/ferrite-bead-on-a-laptop-charging-cable-featured.jpg)
...
![changing advanced power settings in Windows](https://static1.makeuseofimages.com/wordpress/wp-content/uploads/2022/11/chaning-advanced-power-settings-in-windows.jpg)
...
1. Click**Start > Settings** (or**WIN + I**).
2. Go to **System > Power and sleep > Additional power settings** .
3. Select**High performance** .
4. Click**Change plan settings > Change advanced power settings** .
5. Confirm the power settings are set to the optimum levels.
...
![laptop fan settings](https://static1.makeuseofimages.com/wordpress/wp-content/uploads/2022/11/laptop-fan-settings.jpg)
...
![Use Speedtest.net to check your internet speed](https://static1.makeuseofimages.com/wordpress/wp-content/uploads/2023/08/speed-testing-internet-connection.jpg)
 ...
 If there's no change after applying updates, consider a wired Ethernet connection to the router. You should also consider getting one of the [best routers for gaming](https://www.makeuseof.com/tag/best-router-for-gaming/) , allowing your network to prioritize gaming data over other traffic. This will help you get the best performance for your online games, even if others use your network while you're playing.

 Using a gaming laptop? If your system has a Killer network device, the [Intel Killer Control Center](https://www.killernetworking.com/technologies/killer-control-center-2/) can be installed to optimize online gaming.

## 7\. Choose the Right Power Settings for Your GPU

![gpu power mode setting](https://static1.makeuseofimages.com/wordpress/wp-content/uploads/2022/11/gpu-power-mode-setting.jpg)
...
![NVIDIA power management settings](https://static1.makeuseofimages.com/wordpress/wp-content/uploads/2022/11/NVIDIA-power-management-settings.jpg)
...
![Tweak graphics texture settings](https://static1.makeuseofimages.com/wordpress/wp-content/uploads/2023/08/game-settings-on-amd.jpg)
...
## 11\. Keep Your Laptop Clean and Dust-Free to Improve Gaming Performance
 ...
 You'll only enjoy a smoother gaming experience and general performance improvements on your laptop with a proactive attitude to physical maintenance. Dust and dirt are the enemies of performance—that's because they reduce airflow, resulting in a computer that gets too hot. Once the heat builds, the processor, GPU, and most other components will slow down. This doesn't make for an effective gaming machine.
 ...
 You can check out these [cleaning tricks that'll help your laptop look new](https://www.makeuseof.com/cleaning-tricks-to-make-your-laptop-look-like-new/) if you're unsure how to clean it.

## 12\. Turn On Windows Game Mode

![Xbox Game Bar on Windows 11 With They Are Billions in the Background](https://static1.makeuseofimages.com/wordpress/wp-content/uploads/2022/11/xbox-game-bar-on-windows-11-with-they-are-billions-in-the-background.jpg)
...
3. Switch to**On IMAGE** .
4. Select**Game Mode** in the left-hand pane.
5. Switch to**On** .
6. Close to finish.
...
![Windows 11 Updates settings](https://static1.makeuseofimages.com/wordpress/wp-content/uploads/2022/11/windows-11-updates-settings.jpg)
...
1. Open Steam.
2. Head to**Steam > Settings** .
3. In the**Downloads** tab, clear the**Allow downloads during gameplay** check box.
4. Click**OK** to confirm.  
![Disable Steam downloads while you play](https://static1.makeuseofimages.com/wordpress/wp-content/uploads/2023/08/muo-techexp-gaming-laptop-tweaks-steam-downloads-1.jpg)

You can also manage the update rules for individual games.

1. Right-click the game in your Steam library.
2. Select**Properties > Updates** .
3. Set your preferred options for**Automatic updates** and**Background downloads** .

![Adjust Steam updates in your laptop](https://static1.makeuseofimages.com/wordpress/wp-content/uploads/2023/08/muo-techexp-gaming-laptop-tweaks-steam.jpg)
 ...
 Further [tips on optimizing Steam downloads](https://www.makeuseof.com/tag/steam-download-speeds/) can potentially improve your laptop gaming performance too.

## 15\. Optimize Your Laptop for Gaming With Updated Drivers

![The NVIDIA driver downloads page](https://static1.makeuseofimages.com/wordpress/wp-content/uploads/2022/11/the-nvidia-driver-download-page2.jpg)

 Want to really know how to make your laptop faster for gaming? It's all about the drivers.

 If you're unsure how to optimize your gaming laptop, one of the first things you should do is keep your device drivers updated. Fortunately, this is usually a straightforward process, usually occurring automatically during standard OS updates. But if your hardware drivers don't automatically update, check out these [free driver updaters for Windows](https://www.makeuseof.com/windows-best-free-driver-updaters/) to keep your gaming laptop optimized.
 ...
 Instead, ensure the GPU management software (such as Nvidia GeForce Experience or AMD Gaming Evolved) is set to update automatically. If you don't use any GPU management software, you should manually [update your GPU drivers](https://www.makeuseof.com/update-graphics-drivers-in-windows-10/) to get maximum performance. Be sure to keep your controller and audio drivers up-to-date, too.
...
2. Enter**dxdiag** .
3. Wait for the DirectX Diagnostic Tool (DXDiag) to load.
4. On the**System** tab, look for the DirectX Version at the bottom of the list.  
![Check DirectX settings in DxDiag](https://static1.makeuseofimages.com/wordpress/wp-content/uploads/2023/08/dxdiag.jpg)

To update DirectX:

1. Go to**Start > Settings** (or**WIN + I**).
...
![windows task manager affinity setting](https://static1.makeuseofimages.com/wordpress/wp-content/uploads/2022/11/windows-task-manager-affinity-setting.jpg)
 ...
 You can also check out our guide on [how to use Windows Task Manager](https://www.makeuseof.com/how-to-use-windows-task-manager/) so you can make the most out of it.
...
## 19\. Overclock the Laptop Graphics Card for Optimized Gaming
 ...
 Usually, this is handled by the laptop's built-in cooling system. You should regularly clean the heatsinks and fans, as outlined in #11\. If not, your computer will automatically shut down—as a safety precaution—when it gets too hot.

 Looking for an overclocking tool for your GPU? The most popular at present is [MSI Afterburner](https://www.msi.com/page/afterburner) , which is suitable for Nvidia and AMD graphics cards.

 You can enjoy good results with overclocking, but it is something you must do with care. Our [guide to overclocking your GPU safely](https://www.makeuseof.com/how-to-overclock-gpu/) should help here.

## 20\. Upgrade Your Laptop for Increased Gaming Performance

![close up with a pc ram](https://static1.makeuseofimages.com/wordpress/wp-content/uploads/2022/08/holding-laptop-ram-in-hands.jpg)

 Image Credit: borevina/[Shutterstock](https://www.shutterstock.com/image-photo/service-technician-holds-new-ram-his-1798630240)
...
1. **RAM** : increasing the memory amount and speed can have a massive impact.
2. **Storage** : switching to a fast [SATA or NVMe solid-state drive (SSD)](https://www.makeuseof.com/nvme-vs-sata-vs-m2-differences/) will improve game performance considerably.
3. **Battery** : batteries are unable to keep games running for any duration with the full settings enabled.

 Furthermore, if you want a cheap upgrade, why not improve your personal game performance with an external keyboard and mouse designed for optimum gaming? And if your laptop's built-in monitor is too small, you can [connect multiple monitors to your laptop](https://www.makeuseof.com/connect-multiple-display-monitors-laptop/) for the ultimate gaming experience.

 If you're unsure how to upgrade your laptop RAM for gaming, you should check out our [step-by-step laptop RAM upgrade guide](https://www.makeuseof.com/tag/upgrading-a-laptops-ram-step-by-step-si-x2/) to get started.
